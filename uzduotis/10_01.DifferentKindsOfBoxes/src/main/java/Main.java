public class Main {
    ...
    public static void main(String[] args) {
        ...
        coffeeBox.add(new Item("Pirka", 5));
        coffeeBox.add(new Item("Kopi Luwak", 5));

        System.out.println(coffeeBox.isInBox(new Item("Saludo")));
        System.out.println(coffeeBox.isInBox(new Item("Pirka")));
        ...
        oneItemBox.add(new Item("Pirka", 5));

        System.out.println(oneItemBox.isInBox(new Item("Saludo")));
        System.out.println(oneItemBox.isInBox(new Item("Pirka")));
